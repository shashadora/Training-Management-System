	...
	try {               
		...
		PreparedStatement reg = con.prepareStatement(query);
                ...
                while (rs.next()) {
                    ...
                    String schedule_ID = courses_rs.getString("ID");
                    out.println("<tr>");
                        ...
                        out.println("<td>");
                        out.println("<button class='btn btn-info'><i class='fa fa-pencil'></i><a href='applyForCourse_apply.jsp?id="+schedule_ID+"'>Apply</a></button>");
                    out.println("</td>");
                    out.println("</tr>");
                }
                }
